...
namespace Modullo\ModulesLmsLearningCode;

use Illuminate\Support\ServiceProvider;

class ModulesLmsLearningCodeServiceProvider  extends ServiceProvider
{
    public function boot()
    {
        $this->loadRoutesFrom(__DIR__.'/routes/web.php');
        $this->loadViewsFrom(__DIR__.'/resources/views', 'modules-lms-learning-code');
